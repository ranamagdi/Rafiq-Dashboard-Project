    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
      ...
      <div className="auth-container">
        <div className="flex  gap-2 items-center  ">
          ...
          <div>
            <h3 className="">Initialize New Project</h3>
            <p className="">
        ...
        <form className="auth-form" onSubmit={handleSubmit(handleSubmitForm)}>
          ...
          <div className="form-section">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[#4F5F7B99] text-[11px] font-normal">
                Optional
              </span>
            </div>
      ...
      <div className="footer-content bg-[#F1F3FF] flex justify-between gap-2 p-3 info-container">
        <svg
          width="12"
          height="15"
          viewBox="0 0 12 15"
        ...
        <span className="text-[#4F5F7B] font-normal text-[12px]">
